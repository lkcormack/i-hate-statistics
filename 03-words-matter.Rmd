...
Okay, first, as discussed in the last chapter, the fact that we use the word "significant" to describe a probability that is over some completely arbitrary criterion is bullshit. It makes no sense. It's just stupid. But our use of word "significant" to mean "unlikely if chance alone were operating" is perverse. Why? Because everybody coming in to a statistics class already "knows" what the word "significant" means!
